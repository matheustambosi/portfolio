...
export default function Generate() {
    ...
    useEffect(() => {
        const getData = async () => {
            ...
            const query = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Modalidade/BuscandoAtletas`, {
                headers: {
    ...
    async function salvarAtleta() {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/Atleta/SalvarAtleta`, {
            method: 'POST',
